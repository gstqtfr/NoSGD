...
/**
  ...
  * [[org.garagescience.deeplearning.nosgd.XOR!teachImpl]] and `classifyImpl` methods and expose their activation
  * function via `activationFunction`
  */
trait NeuralNetwork {
  ...
  /**
    ...
    *
    * returns the sequence - vector of Doubles the input was classified as. The result is not rounded and to get the
